  ...
  return (
    <div className="bg-[#f9fafb]">
      <div className="lg:mx-52 pt-20 pb-14 2xl:mx-80">
        <h1 className="font-[cabinet-extrabold] relative leading-[75px] text-[2.5rem]">
          <span className=" absolute left-[-23px]">
            <svg
              class="cs4ft ci3v9 c5pme cfr6o cc0m4 c90ns"
              width="22"
              height="30"
      ...
      <div className=" flex justify-center items-center">
        <button className="second-btn font-[inter]">Explore More</button>
      </div>
    </div>
  );
};
