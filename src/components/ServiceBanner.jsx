  ...
  return (
    <div className="services-sec">
      <div className="grid grid-cols-12 lg:mx-52 2xl:mx-80 z-40">
        <div className="col-span-8 py-20 lg:h-auto 2xl:h-[80vh] flex flex-col justify-center">
          <h1 className="font-[cabinet-bold] text-[#ffffff] relative leading-[75px] text-[4rem]">
            {title}
          </h1>
